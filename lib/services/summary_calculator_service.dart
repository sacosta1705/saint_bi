...
class ManagementSummaryCalculator {
  ...
  ManagementSummary calculate({
    ...
    // Esta es TU lógica original, y es 100% CORRECTA y necesaria para determinar
    // si una venta a crédito ya fue pagada.
    ...
    // Este bucle los procesa a ambos. El 'signo' (1 o -1) se
    // encarga de sumar o restar, respectivamente.
    final List<Invoice> allBillingTransactions =
        invoices.where((inv) => inv.type == 'A' || inv.type == 'B').toList();
