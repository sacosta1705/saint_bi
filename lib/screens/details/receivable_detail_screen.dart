      ...
      body: ListView(
        ...
        children: [
          _buildDetailCard(
            ...
            children: [
              _buildDetailRow(
                  'Numero de documento:', accountReceivable.docNumber),
              _buildDetailRow('Tipo de operacion:', accountReceivable.type),
              _buildDetailRow(
                  'Emision:',
                  DateFormat('yyyy-MM-dd')
                      .format(accountReceivable.emissionDate)),
              _buildDetailRow('Vencimiento:',
